...
function ToptalBadge() {
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="flex w-[100px] flex-col items-center gap-1 px-0 pt-4 pb-5 text-center text-white"
          style={{
            background: "linear-gradient(153deg, #0667ff 18%, #204ecf 40%, #0f256e 80%)",
            clipPath: hexClip,
          }}
        >
          <svg width={32} viewBox="0 0 60 17" xmlns="http://www.w3.org/2000/svg">
            <path
          ...
          <h3 className="m-0 text-[9px] font-bold leading-none">TOP 3% TALENT</h3>
          <div className="h-px w-[56px]" style={{ background: "#25a9ef" }} />
          <span className="text-[8px] opacity-80">Vetted by</span>
          <svg viewBox="0 0 108 30" width={48} xmlns="http://www.w3.org/2000/svg">
